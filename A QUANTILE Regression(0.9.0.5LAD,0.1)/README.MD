# Quantile Regression for Risk-Aware Demand Forecasting 🐺
...
- Underestimating demand → stockouts, lost revenue, SLA breaches  
- Overestimating demand → idle inventory, unnecessary operational cost  
